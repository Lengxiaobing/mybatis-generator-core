...
public class MyBatisGeneratorTest {
    ...
    public void testGenerateMyBatis3WithInvalidConfig() throws Exception {
        ...
        Configuration config = cp.parseConfiguration(this.getClass().getClassLoader().getResourceAsStream("generatorTemplate.xml"));
        // 自定义实现MyDefaultShellCallback类，实现Mapper.java文件的meger操作，
        // 在生成的Mapper.java类中自定义添加的方法不在进行全覆盖操作
